        ...
        >
          {item.title.split("").map((item: any, i: any) => (
            <motion.span
              ...
              className="text-[165px] leading-none inline-block uppercase font-FoundersGrotesk text-hoverText font-bold text-center pointer-events-none" // Changed text-about to text-hoverText
              key={i}
            >
              {item}
            </motion.span>
